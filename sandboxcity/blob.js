var unityFramework = ( () => {
    ...
    return (function(unityFramework={}) {
        ...
        function _ReturnFocusProvider() {
            setFocus()
        }
        function _ShowInterstitialAdProvider() {
           // showInterstitialAd()
        }
        function _ShowRewardedAdProvider() {
           // showRewardedAd()
        }
        ...
        var wasmImports = {
            ...
            "ReturnFocusProvider": _ReturnFocusProvider,
            "ShowInterstitialAdProvider": _ShowInterstitialAdProvider,
            "ShowRewardedAdProvider": _ShowRewardedAdProvider,
            "__dlsym": ___dlsym,
