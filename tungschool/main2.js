 const hideFullScreenButton = "";
        ...
        const loaderUrl = buildUrl + "/School.loader.js";
        const config = {
            dataUrl: buildUrl + "/School.data.gz",
            frameworkUrl: buildUrl + "/School.framework.js.gz",
            codeUrl: buildUrl + "/School.wasm.gz",
        streamingAssetsUrl: "StreamingAssets",
            companyName: "kassir",
            productName: "Побег из Тюрьмы Спаси Заключенного",
